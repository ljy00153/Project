    ...
    void step() {
        ...
        case FMT_CFG: {
            ...
            if (opcode == OP_NOP) {
                ...
                case 9:  value = 96; break;   // K_SIZE
                case 10: value = 48; break;    // N_SIZE
...
int main() {
    ISASim sim;
    sim.load_program_txt("../controller_assembly.hex"); // assembler 出來的 program.hex 改名或直接用這個檔名
    sim.run();
    return 0;
}