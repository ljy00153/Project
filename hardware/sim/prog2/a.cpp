...
const int N = 72; // A 的行數 / B 的列數
const int P = 64; // B 的行數
// ==========================================
...
int main() {
    ...
    int target_j = 32;  // 你程式碼中的 j (注意: 若 P=32, 索引範圍是 0~31)
    ...
    if (target_i >= M || target_j >= P) {
        ...
        cout << "\n================ DEBUG INFO ================" << endl;
        cout << "觀察對象: C[" << dec << target_i << "][" << target_j << "]" << endl;
        cout << "公式: sum += A[" << target_i << "][k] * B[k][" << target_j << "]" << endl;
        cout << "--------------------------------------------" << endl;
        cout << " k |  A_val (Hex) |  B_val (Hex) |     Product      |   Current Sum" << endl;
        cout << "---|--------------|--------------|------------------|------------------" << endl;
        ...
        cout << "--------------------------------------------" << endl;
        cout << "最終結果 (Hex): " << hex << uppercase << debug_test << endl;
        cout << "============================================" << endl;
    }
    // ==========================================
    // 輸出設定：十六進位 (HEX)
